...
4. **Input method** — DTMF only, voice only, or both (DTMF + voice via Lex)?
...
7. **TTS voice** — Which voice? (Default: Joanna, Neural engine)
...
### Step 5: Deciding Between DTMF and Lex
...
{
  "Version": "2019-10-30",
  "StartAction": "GREETING_UUID",
  "Metadata": {
    "entryPointPosition": { "x": 39, "y": 40 },
    "ActionMetadata": {
      "GREETING_UUID": { "position": { "x": 250, "y": 200 } },
      "MENU_UUID": { "position": { "x": 550, "y": 200 } },
      "OPT1_UUID": { "position": { "x": 900, "y": 50 } },
      "OPT2_UUID": { "position": { "x": 900, "y": 250 } },
      "ERROR_UUID": { "position": { "x": 900, "y": 450 } },
      "DISCONNECT_UUID": { "position": { "x": 1250, "y": 250 } }
    }
  },
  "Actions": [
    {
