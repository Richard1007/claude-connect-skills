# Sunrise Health Clinic IVR — Test Results
...
**Result:** TIMEOUT (4/6 observations passed, 2 failed)
...
## S12-S14: Voice Scenarios

**Expected:** Voice input scenarios

**Actual:** NOT TESTED — Voice scenarios require Chat API or manual testing
...
| S10 | PASSED | 6/6 |
| S11 | PASSED | 6/6 |
| S12-S14 | SKIPPED | Voice not tested |
| S15 | PASSED | 5/5 |
| S16 | FAILED | 4/6 (2 failed) |

**Overall:** 11/13 DTMF scenarios fully passed (84.6% pass rate)
